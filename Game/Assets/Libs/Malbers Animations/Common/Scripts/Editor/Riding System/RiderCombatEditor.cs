...
namespace MalbersAnimations.HAP
{
    ...
    public class RiderCombatEditor : Editor
    {
        ...
        private void DrawAdvanced()
        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            {
                EditorGUILayout.PropertyField(ForceNormalUpdate, new GUIContent("Force Normal Update", "When the Rider is Aiming the Rider and Mount Animators Update mode  will change to 'Normal', So I can modify de bones on Late UPDATE"));
            }
            EditorGUILayout.EndVertical();
