...
namespace MalbersAnimations.HAP
{
    ...
    public partial class RiderCombat
    {
        ...
        protected virtual void InitRiderCombat()
        {
            ...
            if (UseInventory)
            {
                HolderBack.gameObject.SetActive(false);
                HolderLeft.gameObject.SetActive(false);
                HolderRight.gameObject.SetActive(false);
            }
        }
        ...
        public virtual void AimMode()
        {
            ...
            if (StrafeOnTarget)
            {
                Rider.Montura.Animal.UseCameraInput = Aimer.ForcedTarget ? true : DefaultMonturaCamBase;
            }
        }
        ...
        protected virtual void LookDirectionHorizontal()
        {
            ...
            float NewHorizontalAngle = (Vector3.Angle(dir, _t.root.forward) * ((Aimer.ForcedTarget ? TargetSide : CameraSide) ? 1 : -1)) / 180; //Get the Normalized value for the look direction
        ...
        private void SetActiveAbility()
        {
            ...
            Aimer.AimOrigin = ActiveAbility.AimRayOrigin(); //IMPORTANT Set the Aim Origin
        }
