...
namespace MalbersAnimations.HAP
{
    ...
    public class MRider : MonoBehaviour, IAnimatorListener
    {
        ...
        #region Properties
        /// <summary>Returns if the Rider is on the horse and Mount animations are finished</summary>
       ...
       // protected float SAim_Weight;
        ...
        void Start()
        {
            ...
            if (StartMounted) Start_Mounted();                         //Set All if Started Mounted is Active   
        ...
        public virtual void End_Mounting()
        {
            ...
            if (Anim)
            {
                ...
                Anim.SetInteger(Montura.Animal.hash_Mode, Montura.Animal.ModeID);

                Montura.Animal.OnGrounded.AddListener(AnimalGrounded);
                Montura.Animal.OnStateChange.AddListener(AnimalState);
                Montura.Animal.OnModeChange.AddListener(AnimalMode);
        ...
        void DisconectRiderAnims()
        {
            ...
            Montura.Animal.OnModeChange.RemoveListener(AnimalMode);
        ...
        /// <summary> Check without Input if the Rider can Mount Dismount or Call an Animal </summary>
